...
TAG_CLIENT_SATNOGS="1.9.2+sa2kng-f4tnk"
TAG="sa2kng"
TAG_F4TNK="sa2kng-f4tnk"
REPO_ROOT="knegge"
...
ARGS+=" --build-arg FLOWGRAPHS_URL=https://gitlab.com/f4tnk/satnogs-flowgraphs.git"
ARGS+=" --build-arg FLOWGRAPHS_BRANCH=sa2kng-f4tnk"
ARGS+=" --build-arg FLOWGRAPHS_VER=1.6+${TAG}"
ARGS+=" --build-arg CLIENT_URL=https://gitlab.com/f4tnk/satnogs-client.git"
ARGS+=" --build-arg CLIENT_BRANCH=sa2kng-f4tnk"
