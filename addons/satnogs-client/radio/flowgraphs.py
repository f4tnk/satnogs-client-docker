...
SATNOGS_FLOWGRAPH_MODE_DEFAULT = 'FSK'
...
class Flowgraph():
    ...
    def __init__(self, device, sampling_rate, frequency, mode, baud, output_data):
        ...
        self.parameters = {
            ...
            'lo-transverter': client_settings.SATNOGS_LO_TRANSVERTER,
            ...
            'master-clock-rate': client_settings.SATNOGS_MASTER_CLOCK_RATE,
            'clock-source': client_settings.SATNOGS_CLOCK_SOURCE,
